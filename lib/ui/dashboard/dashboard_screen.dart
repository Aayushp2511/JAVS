    ...
    if (_selectedFile != null && _fileBytes != null) {
      if (_isDecryptMode) {
        ...
        try {
          ...
          setState(() {
            _output = "ERROR: CORRUPT_PAYLOAD_OR_WRONG_SEED";
            _isProcessing = false;
          });
        }
      } else {
        final encryptedBytes = IDMCEngine.processBytes(_fileBytes!, seed, decrypt: false);
        final result = base64Encode(encryptedBytes);
        ref.read(reactProvider.notifier).audit(encryptedBytes);
